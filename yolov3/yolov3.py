...
# -*- coding: utf-8 -*-
"""
@ScriptName  : yolov3.py
@Project     : Object-Detection-YOLOv3-TF2
@Author      : Meng Peng
@Date        : 30-08-2020
@Description : YOLOv3 main functions
"""
import numpy as np
...
def YOLOv3(input_layer, NUM_CLASS):
    ...
    conv_lbbox = convolutional(conv_lobj_branch, (1, 1, 1024, 3 * (NUM_CLASS + 5)), activate=False,
                               bn=False)
    ...
    conv_mbbox = convolutional(conv_mobj_branch, (1, 1, 512, 3 * (NUM_CLASS + 5)), activate=False,
                               bn=False)
    ...
    conv_sbbox = convolutional(conv_sobj_branch, (1, 1, 256, 3 * (NUM_CLASS + 5)), activate=False,
                               bn=False)
...
def YOLOv3_tiny(input_layer, NUM_CLASS):
    ...
    conv_lbbox = convolutional(conv_lobj_branch, (1, 1, 512, 3 * (NUM_CLASS + 5)), activate=False,
                               bn=False)
    ...
    conv_mbbox = convolutional(conv_mobj_branch, (1, 1, 256, 3 * (NUM_CLASS + 5)), activate=False,
                               bn=False)
...
def decode(conv_output, NUM_CLASS, i=0):
    ...
    pred_prob = tf.sigmoid(
        conv_raw_prob)  # calculating the predicted probability category box object
