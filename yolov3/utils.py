...
@Author      : Meng Peng
@Date        : 04-09-2020
@Description : YOLOv3 additional utility functions
"""
import cv2
import time
import random
    ...
    for i, bbox in enumerate(bboxes):
        ...
        if show_label:
            ...
            (text_width, text_height), baseline = cv2.getTextSize(label,
                                                                  ...
                                                                  font_scale, thickness=bbox_thick)
            ...
            cv2.putText(image, label, (x1, y1 - 4), cv2.FONT_HERSHEY_COMPLEX_SMALL,
                        font_scale, text_colors, bbox_thick, lineType=cv2.LINE_AA)
...
# detect from webcam
def detect_realtime(Yolo, output_path, input_size=416, show=False, classes=YOLO_COCO_CLASSES,
